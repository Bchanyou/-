            ...
            if (cookies != null) {
                for (Cookie cookie : cookies) {
                    if (cookie.getName().equals("savedId")) {
                        ...
                        // 6. JSP 페이지로 포워드
                        RequestDispatcher dis = request.getRequestDispatcher("calendar.jsp");
