					...
					<div class="drop_down_wrap bdr_wrap">
						<div class="drop_down">
							...
							<div class="drop_sub pa50">
								<p>유통기한 이미지가 인식되지 않을 경우, 먼저 사진 촬영시 흔들림으로 인해 이미지가 흐려지지 않았는지
									확인해주세요.</p>
								<p>유통기한이 카메라 중앙에 위치하도록 가까이 촬영하시면 더욱 빠르고 정확한 업로드에 도움이 되며, 이미지
									인식 외에도 직접 날짜 수정이 가능합니다.</p>
							</div>
						</div>
						<div class="drop_down">
							<div class="drop_title">
