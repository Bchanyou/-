		...
		<form class="tb_wrap" method="post" action="MemberLoginCon"
			...
			<div class="bdr_wrap row" id="login">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="id" maxlength="50"
								...
								value="<%=session.getAttribute("savedId") != null ? session.getAttribute("savedId") : ""%>"></td>
						</tr>
						<tr>
							<th>비밀번호</th>
				...
				<div class="login_btns my20">
					<div class="lb">
 						<div class="chk_box">
							<input type="checkbox" id="save_id" name="save_id"
								class="login_chk"
								<%=session.getAttribute("savedId") != null ? "checked" : ""%>>
					...
					<div class="rb">
						<span><a href="find_id.jsp">아이디 찾기</a></span> <span><a
							href="find_pw.jsp">비밀번호 찾기</a></span>
					</div>
				</div>
