...
<head>
    ...
    <meta property="og:title" content="냉장고를부탁해">
    <meta property="og:description" content="사이트설명">
    <meta property="og:image" content="사이트주소/images/common/kakao_logo_400x210.png">

    <meta name="format-detection" content="telephone=no" />
    <meta name="description" content="사이트설명" />
    <meta name="keywords" content="사이트관련키워드" />
    <meta name="classification" content="사이트분류" />
    <meta name="author" content="TeamChobao" />
    <meta name="title" content="냉장고를부탁해">
    <meta name="apple-mobile-web-app-title" content="냉장고를부탁해">
    ...
    <!--Add Js-->
    <script src="https://kit.fontawesome.com/b9310abc97.js" crossorigin="anonymous"></script>
    ...
    <div id="wrap">
        ...
        <header id="header" class="px50">
            <div class="hdr_inner">
                ...
                <h1 id="hdr_logo"><a href="/"><strong><span>냉장고를 </span>부탁해</strong></a></h1>

                <!-- Gnb -->
                <nav id="gnb">
                    <ul>
                        <li>
                            <div class="menu_dep1"><a href="#">my냉장고</a></div>
                            <ol class="menu_dep2">
                                <li>my냉장고</li>
                                <li>품목 관리</li>
                            </ol>
                        ...
                        <li>
                            <div class="menu_dep1"><a href="#">레시피</a></div>
                            <ol class="menu_dep2">
                                <li>레시피 검색</li>
                                <li>추천 레시피</li>
                            </ol>
                        ...
                        <li><a href="#">정기구매</a></li>
                        <li>
                            <div class="menu_dep1"><a href="#">고객센터</a></div>
                            <ol class="menu_dep2">
                                <li>FAQ</li>
                                <li>1:1문의</li>
                            </ol>
            ...
            <section id="container">
                ...
                <section id="sub_vis" class="sv01">
                    <div id="sub_tit" class="w1280">
                        <h2><strong class="font">my냉장고</strong></h2>
                        <p>현재 냉장고에 보유중인 품목을 확인하고<br>간편하게 유통기한을 관리해보세요!</p>
                    </div>
                </section>
                ...
                <section id="content" class="my120">
                    ...
                    <section class="sub_cont w1280">
                        <div class="big_tit">
                            <h3><strong>my냉장고</strong></h3>
                            <p>이미지를 클릭하여 해당 칸에 보관된 식재료를 확인할 수 있습니다.</p>
                        </div>
                        <div class="s01_fridge"><img src="images/sub/fridge.png" alt="my냉장고"></div>

                        <!-- 품목리스트 -->
                        <form class="tb_wrap" action="" name="">

                            <div class="mid_tit my20 loca">
                                <h4><span>01</span><strong>냉장칸</strong></h4>
                            </div>
                        ...
                        <div class="modal_box w1280 pa50">
                            ...
                            <form action="IngredientAddCon">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="unit">
                                                    ...
                                                    <input type="text" class="unit_input" name="unit_stock" disabled>
                                                </td>
                                                <td class="qtt_num">
                                                    <input type="number" name="stock" value="1">
                                                </td>
                                                <td class="date_picker">
                                                    <input type="date" id="date_buy" name="date_buy" class="date_format" onchange="formatDate()">
                                                </td>
                                                <td class="date_picker">
                                                    <input type="date" id="date_exp" name="date_exp" class="date_format" onchange="formatDate()">
                                                </td>
                                                <td>
                                                    <div class="select_wrap loca">
                                                        <select name="location" name="location" class="select" title="보관위치">
                                ...
                                <div class="btn_wrap my30">
                                    ...
                                    <div class="lb">
                                        <label for="file1" class="btn_grn file_upload">사진 업로드</label> 
