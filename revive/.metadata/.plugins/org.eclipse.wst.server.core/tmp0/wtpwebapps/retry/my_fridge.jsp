...
<meta property="og:image"
	content="사이트주소/images/common/kakao_logo_400x210.png">
	...
	<div id="wrap">
		...
		<header id="header" class="px50">
			<div class="hdr_inner">
				...
				<h1 id="hdr_logo">
					<a href="/"><strong><span>냉장고를 </span>부탁해</strong></a>
				</h1>
					...
					<section class="sub_cont w1280">
						...
						<div class="modal_box w1280 pa50">
							...
							<form action="IngredientAddCon">
										...
										<tbody>
											<tr>
												...
												<td class="qtt_num"><input type="number" name="stock"
													value="1"></td>
												<td class="date_picker"><input type="date"
													id="date_buy" name="date_buy" class="date_format"
													onchange="formatDate()"></td>
												<td class="date_picker"><input type="date"
													id="date_exp" name="date_exp" class="date_format"
													onchange="formatDate()"></td>
												<td>
								...
								<p class="ico_info">상품의 유통기한이 촬영된 사진을 업로드하시면 유통기한이 자동으로
									입력됩니다.</p>
								<div class="btn_wrap my30">

									<div class="lb">
										<label for="file1" class="btn_grn file_upload">사진 업로드</label>
										<input type="file" id="file1" class="inpFile"
											style="display: none;">
		...
		<footer id="footer" class="pdH">
			<div class="ftr_inner">
				<address>
					<span>대표자 : 홍길동</span> <span>사업자등록번호 : 000-00-0000</span> <span>주소
						: 광주광역시 동구 예술길</span> <span>대표전화 : 00-000-0000</span> <span>팩스 :
						00-000-0000</span>
				</address>
				<p class="copyright">Copyright @ 2024 by Connected Inc. All
					Rights Reserved.</p>
			</div>
		</footer>
		<!-- //Footer -->
